...
main(int argc, char *argv[])
{
  ...
  14:	87858593          	addi	a1,a1,-1928 # 888 <statistics+0x88>
  18:	4509                	li	a0,2
  ...
  50:	85458593          	addi	a1,a1,-1964 # 8a0 <statistics+0xa0>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	42ab8b93          	addi	s7,s7,1066 # 8c0 <digits>
 ...
 5da:	2e290913          	addi	s2,s2,738 # 8b8 <statistics+0xb8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a2:	2627b783          	ld	a5,610(a5) # 900 <freep>
 ...
 6d0:	00e6ea63          	bltu	a3,a4,6e4 <free+0x50>
{
 ...
 712:	1ef73923          	sd	a5,498(a4) # 900 <freep>
}
 716:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 744:	1c053503          	ld	a0,448(a0) # 900 <freep>
 ...
 76c:	19890913          	addi	s2,s2,408 # 900 <freep>
  if(p == (char*)-1)
 770:	5afd                	li	s5,-1
 772:	a88d                	j	7e4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 774:	00000797          	auipc	a5,0x0
 778:	19478793          	addi	a5,a5,404 # 908 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	18f73223          	sd	a5,388(a4) # 900 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a6:	14a73f23          	sd	a0,350(a4) # 900 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 81a:	0c250513          	addi	a0,a0,194 # 8d8 <digits+0x18>
 81e:	00000097          	auipc	ra,0x0
 822:	af8080e7          	jalr	-1288(ra) # 316 <open>
  if(fd < 0) {
 ...
 840:	ab2080e7          	jalr	-1358(ra) # 2ee <read>
 ...
 854:	aae080e7          	jalr	-1362(ra) # 2fe <close>
  return i;
}
 858:	8526                	mv	a0,s1
 ...
 86e:	07e58593          	addi	a1,a1,126 # 8e8 <digits+0x28>
 872:	4509                	li	a0,2
 ...
 882:	a58080e7          	jalr	-1448(ra) # 2d6 <exit>
