...
main(void)
{
  ...
  12:	92a50513          	addi	a0,a0,-1750 # 938 <statistics+0x8c>
  ...
  3a:	91a90913          	addi	s2,s2,-1766 # 950 <statistics+0xa4>
  3e:	854a                	mv	a0,s2
  ...
  6e:	93650513          	addi	a0,a0,-1738 # 9a0 <statistics+0xf4>
  72:	00000097          	auipc	ra,0x0
  76:	698080e7          	jalr	1688(ra) # 70a <printf>
        exit(1);
  7a:	4505                	li	a0,1
  ...
  8c:	8b050513          	addi	a0,a0,-1872 # 938 <statistics+0x8c>
  ...
  a0:	8a450513          	addi	a0,a0,-1884 # 940 <statistics+0x94>
  a4:	00000097          	auipc	ra,0x0
  a8:	326080e7          	jalr	806(ra) # 3ca <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	88a50513          	addi	a0,a0,-1910 # 938 <statistics+0x8c>
  b6:	00000097          	auipc	ra,0x0
  ba:	30c080e7          	jalr	780(ra) # 3c2 <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	8a850513          	addi	a0,a0,-1880 # 968 <statistics+0xbc>
  c8:	00000097          	auipc	ra,0x0
  cc:	642080e7          	jalr	1602(ra) # 70a <printf>
      exit(1);
  d0:	4505                	li	a0,1
  ...
  de:	91e58593          	addi	a1,a1,-1762 # 9f8 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	89e50513          	addi	a0,a0,-1890 # 980 <statistics+0xd4>
  ea:	00000097          	auipc	ra,0x0
  ee:	2d0080e7          	jalr	720(ra) # 3ba <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	89650513          	addi	a0,a0,-1898 # 988 <statistics+0xdc>
  fa:	00000097          	auipc	ra,0x0
  fe:	610080e7          	jalr	1552(ra) # 70a <printf>
      exit(1);
 102:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	55250513          	addi	a0,a0,1362 # 9c8 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	486b8b93          	addi	s7,s7,1158 # 9c8 <digits>
 ...
 686:	33e90913          	addi	s2,s2,830 # 9c0 <statistics+0x114>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74e:	2be7b783          	ld	a5,702(a5) # a08 <freep>
 ...
 77c:	00e6ea63          	bltu	a3,a4,790 <free+0x50>
{
 ...
 7be:	24f73723          	sd	a5,590(a4) # a08 <freep>
}
 7c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f0:	21c53503          	ld	a0,540(a0) # a08 <freep>
 ...
 818:	1f490913          	addi	s2,s2,500 # a08 <freep>
  if(p == (char*)-1)
 81c:	5afd                	li	s5,-1
 81e:	a88d                	j	890 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 820:	00000797          	auipc	a5,0x0
 824:	1f078793          	addi	a5,a5,496 # a10 <base>
 828:	00000717          	auipc	a4,0x0
 82c:	1ef73023          	sd	a5,480(a4) # a08 <freep>
 830:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	1aa73d23          	sd	a0,442(a4) # a08 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8c6:	07e50513          	addi	a0,a0,126 # 940 <statistics+0x94>
 8ca:	00000097          	auipc	ra,0x0
 8ce:	af8080e7          	jalr	-1288(ra) # 3c2 <open>
  if(fd < 0) {
 8d2:	04054263          	bltz	a0,916 <statistics+0x6a>
 8d6:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8d8:	4481                	li	s1,0
 8da:	03205063          	blez	s2,8fa <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8de:	4099063b          	subw	a2,s2,s1
 8e2:	009a05b3          	add	a1,s4,s1
 8e6:	854e                	mv	a0,s3
 8e8:	00000097          	auipc	ra,0x0
 8ec:	ab2080e7          	jalr	-1358(ra) # 39a <read>
 8f0:	00054563          	bltz	a0,8fa <statistics+0x4e>
      break;
    }
    i += n;
 8f4:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8f6:	ff24c4e3          	blt	s1,s2,8de <statistics+0x32>
  }
  close(fd);
 8fa:	854e                	mv	a0,s3
 8fc:	00000097          	auipc	ra,0x0
 900:	aae080e7          	jalr	-1362(ra) # 3aa <close>
  return i;
}
 904:	8526                	mv	a0,s1
 906:	70a2                	ld	ra,40(sp)
 908:	7402                	ld	s0,32(sp)
 90a:	64e2                	ld	s1,24(sp)
 90c:	6942                	ld	s2,16(sp)
 90e:	69a2                	ld	s3,8(sp)
 910:	6a02                	ld	s4,0(sp)
 912:	6145                	addi	sp,sp,48
 914:	8082                	ret
      fprintf(2, "stats: open failed\n");
 916:	00000597          	auipc	a1,0x0
 91a:	0ca58593          	addi	a1,a1,202 # 9e0 <digits+0x18>
 91e:	4509                	li	a0,2
 920:	00000097          	auipc	ra,0x0
 924:	dbc080e7          	jalr	-580(ra) # 6dc <fprintf>
      exit(1);
 928:	4505                	li	a0,1
 92a:	00000097          	auipc	ra,0x0
 92e:	a58080e7          	jalr	-1448(ra) # 382 <exit>
