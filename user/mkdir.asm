...
main(int argc, char *argv[])
{
  ...
  42:	86258593          	addi	a1,a1,-1950 # 8a0 <statistics+0x88>
  46:	4509                	li	a0,2
  ...
  60:	85c58593          	addi	a1,a1,-1956 # 8b8 <statistics+0xa0>
  64:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	432b8b93          	addi	s7,s7,1074 # 8e0 <digits>
 ...
 5f2:	2ea90913          	addi	s2,s2,746 # 8d8 <statistics+0xc0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ba:	26a7b783          	ld	a5,618(a5) # 920 <freep>
 ...
 6e8:	00e6ea63          	bltu	a3,a4,6fc <free+0x50>
{
 ...
 72a:	1ef73d23          	sd	a5,506(a4) # 920 <freep>
}
 72e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75c:	1c853503          	ld	a0,456(a0) # 920 <freep>
 ...
 784:	1a090913          	addi	s2,s2,416 # 920 <freep>
  if(p == (char*)-1)
 788:	5afd                	li	s5,-1
 78a:	a88d                	j	7fc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 78c:	00000797          	auipc	a5,0x0
 790:	19c78793          	addi	a5,a5,412 # 928 <base>
 794:	00000717          	auipc	a4,0x0
 798:	18f73623          	sd	a5,396(a4) # 920 <freep>
 79c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7be:	16a73323          	sd	a0,358(a4) # 920 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 832:	0ca50513          	addi	a0,a0,202 # 8f8 <digits+0x18>
 836:	00000097          	auipc	ra,0x0
 83a:	af8080e7          	jalr	-1288(ra) # 32e <open>
  if(fd < 0) {
 83e:	04054263          	bltz	a0,882 <statistics+0x6a>
 842:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 844:	4481                	li	s1,0
 846:	03205063          	blez	s2,866 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 84a:	4099063b          	subw	a2,s2,s1
 84e:	009a05b3          	add	a1,s4,s1
 852:	854e                	mv	a0,s3
 854:	00000097          	auipc	ra,0x0
 858:	ab2080e7          	jalr	-1358(ra) # 306 <read>
 85c:	00054563          	bltz	a0,866 <statistics+0x4e>
      break;
    }
    i += n;
 860:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 862:	ff24c4e3          	blt	s1,s2,84a <statistics+0x32>
  }
  close(fd);
 866:	854e                	mv	a0,s3
 868:	00000097          	auipc	ra,0x0
 86c:	aae080e7          	jalr	-1362(ra) # 316 <close>
  return i;
}
 870:	8526                	mv	a0,s1
 ...
 886:	08658593          	addi	a1,a1,134 # 908 <digits+0x28>
 88a:	4509                	li	a0,2
 88c:	00000097          	auipc	ra,0x0
 890:	dbc080e7          	jalr	-580(ra) # 648 <fprintf>
      exit(1);
 894:	4505                	li	a0,1
 896:	00000097          	auipc	ra,0x0
 89a:	a58080e7          	jalr	-1448(ra) # 2ee <exit>
