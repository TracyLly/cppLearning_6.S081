...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	08878793          	addi	a5,a5,136 # 90e0 <uninit>
      60:	0000b697          	auipc	a3,0xb
      64:	79068693          	addi	a3,a3,1936 # b7f0 <buf>
    if(uninit[i] != '\0'){
...
00000000000001e4 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     1f6:	dd678793          	addi	a5,a5,-554 # 7fc8 <name>
  ...
  name[0] = 'a';
     ...
     238:	d9478793          	addi	a5,a5,-620 # 7fc8 <name>
...
0000000000000278 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	544a0a13          	addi	s4,s4,1348 # b7f0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
...
000000000000082e <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8cc:	f2858593          	addi	a1,a1,-216 # b7f0 <buf>
...
00000000000009ba <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9ea:	e0a90913          	addi	s2,s2,-502 # b7f0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3c:	db890913          	addi	s2,s2,-584 # b7f0 <buf>
  if(fd < 0){
...
0000000000000b68 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c10:	be458593          	addi	a1,a1,-1052 # b7f0 <buf>
     c14:	8526                	mv	a0,s1
...
0000000000000d1e <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de8:	a0c58593          	addi	a1,a1,-1524 # b7f0 <buf>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    114e:	e6e4b483          	ld	s1,-402(s1) # 7fb8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <buf+0xb60>
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	24078793          	addi	a5,a5,576 # 7458 <statistics+0x1bb6>
  ...
  if(pid == 0){
    ...
    1252:	e8a78793          	addi	a5,a5,-374 # 80d8 <big.1273>
    1256:	00008697          	auipc	a3,0x8
    125a:	e8268693          	addi	a3,a3,-382 # 90d8 <__global_pointer$+0x920>
      big[i] = 'x';
    ...
    1270:	e6078623          	sb	zero,-404(a5) # 90d8 <__global_pointer$+0x920>
    char *args2[] = { big, big, big, 0 };
    1274:	00007797          	auipc	a5,0x7
    1278:	95c78793          	addi	a5,a5,-1700 # 7bd0 <statistics+0x232e>
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1792:	062a8a93          	addi	s5,s5,98 # b7f0 <buf>
      if(cc > sizeof(buf))
    ...
    17b0:	04470713          	addi	a4,a4,68 # b7f0 <buf>
    ...
    180e:	fe6b0b13          	addi	s6,s6,-26 # b7f0 <buf>
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1fb6:	35098993          	addi	s3,s3,848 # c350 <buf+0xb60>
    1fba:	1003d937          	lui	s2,0x1003d
    1fbe:	090e                	slli	s2,s2,0x3
    1fc0:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002ec80>
    pid = fork();
...
0000000000002044 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ac:	f3078793          	addi	a5,a5,-208 # 7fd8 <args.1810>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	02068693          	addi	a3,a3,32 # 80d0 <args.1810+0xf8>
    ...
    20cc:	f1058593          	addi	a1,a1,-240 # 7fd8 <args.1810>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2188:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0800>
...
00000000000021cc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2246:	21678793          	addi	a5,a5,534 # 7458 <statistics+0x1bb6>
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2356:	6705                	lui	a4,0x1
      *b = 99;
    2358:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1800>
    for(b = a; b < a+TOOMUCH; b += 4096){
  ...
  for(i = 0; i < 5000; i++){
    ...
    23c4:	54850513          	addi	a0,a0,1352 # 6908 <statistics+0x1066>
  ...
  if(c != a + 1){
    ...
    2426:	54650513          	addi	a0,a0,1350 # 6968 <statistics+0x10c6>
    ...
    2446:	4e650513          	addi	a0,a0,1254 # 6928 <statistics+0x1086>
    ...
    2462:	4ea50513          	addi	a0,a0,1258 # 6948 <statistics+0x10a6>
...
000000000000249e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2500:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f17ff>
  a = sbrk(0);
    2504:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2564:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f17ff>
  ...
  if(c != a){
    ...
    25ac:	3e050513          	addi	a0,a0,992 # 6988 <statistics+0x10e6>
    ...
    25c8:	40c50513          	addi	a0,a0,1036 # 69d0 <statistics+0x112e>
    ...
    25e6:	40e50513          	addi	a0,a0,1038 # 69f0 <statistics+0x114e>
    ...
    2604:	43050513          	addi	a0,a0,1072 # 6a30 <statistics+0x118e>
    ...
    2620:	44450513          	addi	a0,a0,1092 # 6a60 <statistics+0x11be>
    ...
    263e:	45e50513          	addi	a0,a0,1118 # 6a98 <statistics+0x11f6>
...
0000000000002654 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2678:	44c50513          	addi	a0,a0,1100 # 6ac0 <statistics+0x121e>
    267c:	00003097          	auipc	ra,0x3
    2680:	d3c080e7          	jalr	-708(ra) # 53b8 <open>
    2684:	84aa                	mv	s1,a0
  unlink("sbrk");
    2686:	00004517          	auipc	a0,0x4
    268a:	43a50513          	addi	a0,a0,1082 # 6ac0 <statistics+0x121e>
  ...
  if(pipe((int *) a) != 0){
    ...
    26de:	3ee50513          	addi	a0,a0,1006 # 6ac8 <statistics+0x1226>
    ...
    26fa:	3ea50513          	addi	a0,a0,1002 # 6ae0 <statistics+0x123e>
    ...
    2716:	e8e50513          	addi	a0,a0,-370 # 65a0 <statistics+0xcfe>
...
000000000000272c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2740:	3bc50513          	addi	a0,a0,956 # 6af8 <statistics+0x1256>
  ...
  close(fd);
    ...
    2788:	d2c50513          	addi	a0,a0,-724 # 64b0 <statistics+0xc0e>
...
000000000000279e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d6:	0b650513          	addi	a0,a0,182 # 6888 <statistics+0xfe6>
  ...
  if(pid == 0){
    ...
    282c:	06050513          	addi	a0,a0,96 # 6888 <statistics+0xfe6>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f8:	f9450513          	addi	a0,a0,-108 # 6888 <statistics+0xfe6>
    ...
    294c:	31850513          	addi	a0,a0,792 # 5c60 <statistics+0x3be>
    2950:	faa43c23          	sd	a0,-72(s0)
    2954:	00003797          	auipc	a5,0x3
    2958:	37c78793          	addi	a5,a5,892 # 5cd0 <statistics+0x42e>
...
000000000000297a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    298a:	34a50513          	addi	a0,a0,842 # 6cd0 <statistics+0x142e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    299c:	19050513          	addi	a0,a0,400 # 6b28 <statistics+0x1286>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29b2:	1d250513          	addi	a0,a0,466 # 6b80 <statistics+0x12de>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29d0:	22c50513          	addi	a0,a0,556 # 6bf8 <statistics+0x1356>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29ec:	28050513          	addi	a0,a0,640 # 6c68 <statistics+0x13c6>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29fe:	2c650513          	addi	a0,a0,710 # 6cc0 <statistics+0x141e>
  ...
  unlink("12345678901234");
    ...
    2a7c:	08850513          	addi	a0,a0,136 # 6b00 <statistics+0x125e>
    ...
    2a98:	0b450513          	addi	a0,a0,180 # 6b48 <statistics+0x12a6>
    ...
    2ab4:	10050513          	addi	a0,a0,256 # 6bb0 <statistics+0x130e>
    ...
    2ad0:	15c50513          	addi	a0,a0,348 # 6c28 <statistics+0x1386>
    ...
    2aec:	1a050513          	addi	a0,a0,416 # 6c88 <statistics+0x13e6>
    ...
    2b08:	1dc50513          	addi	a0,a0,476 # 6ce0 <statistics+0x143e>
...
0000000000002b1e <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b2e:	1ee50513          	addi	a0,a0,494 # 6d18 <statistics+0x1476>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b42:	1da50513          	addi	a0,a0,474 # 6d18 <statistics+0x1476>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b56:	20650513          	addi	a0,a0,518 # 6d58 <statistics+0x14b6>
  ...
  if(chdir("/") < 0){
    ...
    2b6a:	22250513          	addi	a0,a0,546 # 6d88 <statistics+0x14e6>
    ...
    2b8a:	19a50513          	addi	a0,a0,410 # 6d20 <statistics+0x147e>
    ...
    2ba6:	19650513          	addi	a0,a0,406 # 6d38 <statistics+0x1496>
    ...
    2bc2:	1aa50513          	addi	a0,a0,426 # 6d68 <statistics+0x14c6>
    ...
    2bde:	1b650513          	addi	a0,a0,438 # 6d90 <statistics+0x14ee>
...
0000000000002bf4 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c12:	10a50513          	addi	a0,a0,266 # 6d18 <statistics+0x1476>
    ...
    2c26:	0f650513          	addi	a0,a0,246 # 6d18 <statistics+0x1476>
    ...
    2c3a:	12250513          	addi	a0,a0,290 # 6d58 <statistics+0x14b6>
    ...
    2c5a:	84250513          	addi	a0,a0,-1982 # 6498 <statistics+0xbf6>
    ...
    2c76:	0ae50513          	addi	a0,a0,174 # 6d20 <statistics+0x147e>
    ...
    2c92:	11a50513          	addi	a0,a0,282 # 6da8 <statistics+0x1506>
    ...
    2cae:	0be50513          	addi	a0,a0,190 # 6d68 <statistics+0x14c6>
...
0000000000002cdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2cee:	20650513          	addi	a0,a0,518 # 6ef0 <statistics+0x164e>
    2cf2:	00002097          	auipc	ra,0x2
    2cf6:	6d6080e7          	jalr	1750(ra) # 53c8 <unlink>
  if(mkdir("dd") != 0){
    2cfa:	00004517          	auipc	a0,0x4
    2cfe:	0c650513          	addi	a0,a0,198 # 6dc0 <statistics+0x151e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d16:	0ce50513          	addi	a0,a0,206 # 6de0 <statistics+0x153e>
  ...
  write(fd, "ff", 2);
    ...
    2d2e:	1c658593          	addi	a1,a1,454 # 6ef0 <statistics+0x164e>
  ...
  if(unlink("dd") >= 0){
    ...
    2d48:	07c50513          	addi	a0,a0,124 # 6dc0 <statistics+0x151e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d5c:	0e050513          	addi	a0,a0,224 # 6e38 <statistics+0x1596>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d74:	0f050513          	addi	a0,a0,240 # 6e60 <statistics+0x15be>
  ...
  write(fd, "FF", 2);
    ...
    2d8c:	10858593          	addi	a1,a1,264 # 6e90 <statistics+0x15ee>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da8:	0f450513          	addi	a0,a0,244 # 6e98 <statistics+0x15f6>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dc0:	a3458593          	addi	a1,a1,-1484 # b7f0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd6:	a1e74703          	lbu	a4,-1506(a4) # b7f0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2df0:	0fc58593          	addi	a1,a1,252 # 6ee8 <statistics+0x1646>
    2df4:	00004517          	auipc	a0,0x4
    2df8:	06c50513          	addi	a0,a0,108 # 6e60 <statistics+0x15be>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e0c:	05850513          	addi	a0,a0,88 # 6e60 <statistics+0x15be>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e22:	04250513          	addi	a0,a0,66 # 6e60 <statistics+0x15be>
  ...
  if(chdir("dd") != 0){
    ...
    2e36:	f8e50513          	addi	a0,a0,-114 # 6dc0 <statistics+0x151e>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e4a:	13a50513          	addi	a0,a0,314 # 6f80 <statistics+0x16de>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e5e:	15650513          	addi	a0,a0,342 # 6fb0 <statistics+0x170e>
  ...
  if(chdir("./..") != 0){
    ...
    2e72:	17250513          	addi	a0,a0,370 # 6fe0 <statistics+0x173e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e88:	06450513          	addi	a0,a0,100 # 6ee8 <statistics+0x1646>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2ea0:	95458593          	addi	a1,a1,-1708 # b7f0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ec2:	fa250513          	addi	a0,a0,-94 # 6e60 <statistics+0x15be>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2eda:	19a50513          	addi	a0,a0,410 # 7070 <statistics+0x17ce>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ef2:	1b250513          	addi	a0,a0,434 # 70a0 <statistics+0x17fe>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f0a:	eba50513          	addi	a0,a0,-326 # 6dc0 <statistics+0x151e>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f20:	ea450513          	addi	a0,a0,-348 # 6dc0 <statistics+0x151e>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f36:	e8e50513          	addi	a0,a0,-370 # 6dc0 <statistics+0x151e>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f4a:	1ea58593          	addi	a1,a1,490 # 7130 <statistics+0x188e>
    2f4e:	00004517          	auipc	a0,0x4
    2f52:	12250513          	addi	a0,a0,290 # 7070 <statistics+0x17ce>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f66:	1ce58593          	addi	a1,a1,462 # 7130 <statistics+0x188e>
    2f6a:	00004517          	auipc	a0,0x4
    2f6e:	13650513          	addi	a0,a0,310 # 70a0 <statistics+0x17fe>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f82:	f6a58593          	addi	a1,a1,-150 # 6ee8 <statistics+0x1646>
    2f86:	00004517          	auipc	a0,0x4
    2f8a:	e5a50513          	addi	a0,a0,-422 # 6de0 <statistics+0x153e>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f9e:	0d650513          	addi	a0,a0,214 # 7070 <statistics+0x17ce>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fb2:	0f250513          	addi	a0,a0,242 # 70a0 <statistics+0x17fe>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc6:	f2650513          	addi	a0,a0,-218 # 6ee8 <statistics+0x1646>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fda:	0ca50513          	addi	a0,a0,202 # 70a0 <statistics+0x17fe>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fee:	08650513          	addi	a0,a0,134 # 7070 <statistics+0x17ce>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3002:	de250513          	addi	a0,a0,-542 # 6de0 <statistics+0x153e>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3016:	26e50513          	addi	a0,a0,622 # 7280 <statistics+0x19de>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    302a:	ec250513          	addi	a0,a0,-318 # 6ee8 <statistics+0x1646>
  ...
  if(unlink("dd/ff") != 0){
    ...
    303e:	da650513          	addi	a0,a0,-602 # 6de0 <statistics+0x153e>
  ...
  if(unlink("dd") == 0){
    ...
    3052:	d7250513          	addi	a0,a0,-654 # 6dc0 <statistics+0x151e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3066:	28e50513          	addi	a0,a0,654 # 72f0 <statistics+0x1a4e>
  ...
  if(unlink("dd") < 0){
    ...
    307a:	d4a50513          	addi	a0,a0,-694 # 6dc0 <statistics+0x151e>
    ...
    309c:	d3050513          	addi	a0,a0,-720 # 6dc8 <statistics+0x1526>
    ...
    30b8:	d3450513          	addi	a0,a0,-716 # 6de8 <statistics+0x1546>
    ...
    30d4:	d3850513          	addi	a0,a0,-712 # 6e08 <statistics+0x1566>
    ...
    30f0:	d5450513          	addi	a0,a0,-684 # 6e40 <statistics+0x159e>
    ...
    310c:	d6850513          	addi	a0,a0,-664 # 6e70 <statistics+0x15ce>
    ...
    3128:	d8450513          	addi	a0,a0,-636 # 6ea8 <statistics+0x1606>
    ...
    3144:	d8850513          	addi	a0,a0,-632 # 6ec8 <statistics+0x1626>
    ...
    3160:	d9c50513          	addi	a0,a0,-612 # 6ef8 <statistics+0x1656>
    ...
    317c:	da850513          	addi	a0,a0,-600 # 6f20 <statistics+0x167e>
    ...
    3198:	dac50513          	addi	a0,a0,-596 # 6f40 <statistics+0x169e>
    ...
    31b4:	db850513          	addi	a0,a0,-584 # 6f68 <statistics+0x16c6>
    ...
    31d0:	dc450513          	addi	a0,a0,-572 # 6f90 <statistics+0x16ee>
    ...
    31ec:	dd850513          	addi	a0,a0,-552 # 6fc0 <statistics+0x171e>
    ...
    3208:	de450513          	addi	a0,a0,-540 # 6fe8 <statistics+0x1746>
    ...
    3224:	de050513          	addi	a0,a0,-544 # 7000 <statistics+0x175e>
    ...
    3240:	de450513          	addi	a0,a0,-540 # 7020 <statistics+0x177e>
    ...
    325c:	de850513          	addi	a0,a0,-536 # 7040 <statistics+0x179e>
    ...
    3278:	e0c50513          	addi	a0,a0,-500 # 7080 <statistics+0x17de>
    ...
    3294:	e2050513          	addi	a0,a0,-480 # 70b0 <statistics+0x180e>
    ...
    32b0:	e2450513          	addi	a0,a0,-476 # 70d0 <statistics+0x182e>
    ...
    32cc:	e2850513          	addi	a0,a0,-472 # 70f0 <statistics+0x184e>
    ...
    32e8:	e2c50513          	addi	a0,a0,-468 # 7110 <statistics+0x186e>
    ...
    3304:	e4050513          	addi	a0,a0,-448 # 7140 <statistics+0x189e>
    ...
    3320:	e4c50513          	addi	a0,a0,-436 # 7168 <statistics+0x18c6>
    ...
    333c:	e5850513          	addi	a0,a0,-424 # 7190 <statistics+0x18ee>
    ...
    3358:	e6450513          	addi	a0,a0,-412 # 71b8 <statistics+0x1916>
    ...
    3374:	e6850513          	addi	a0,a0,-408 # 71d8 <statistics+0x1936>
    ...
    3390:	e6c50513          	addi	a0,a0,-404 # 71f8 <statistics+0x1956>
    ...
    33ac:	e7850513          	addi	a0,a0,-392 # 7220 <statistics+0x197e>
    ...
    33c8:	e7c50513          	addi	a0,a0,-388 # 7240 <statistics+0x199e>
    ...
    33e4:	e8050513          	addi	a0,a0,-384 # 7260 <statistics+0x19be>
    ...
    3400:	e8c50513          	addi	a0,a0,-372 # 7288 <statistics+0x19e6>
    ...
    341c:	b0850513          	addi	a0,a0,-1272 # 6f20 <statistics+0x167e>
    ...
    3438:	e7450513          	addi	a0,a0,-396 # 72a8 <statistics+0x1a06>
    ...
    3454:	e7850513          	addi	a0,a0,-392 # 72c8 <statistics+0x1a26>
    ...
    3470:	e8c50513          	addi	a0,a0,-372 # 72f8 <statistics+0x1a56>
    ...
    348c:	e9050513          	addi	a0,a0,-368 # 7318 <statistics+0x1a76>
...
00000000000034a2 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34b2:	e8250513          	addi	a0,a0,-382 # 7330 <statistics+0x1a8e>
  ...
  if(chdir("dots") != 0){
    ...
    34c4:	e7050513          	addi	a0,a0,-400 # 7330 <statistics+0x1a8e>
  ...
  if(unlink(".") == 0){
    ...
    34d6:	e2650513          	addi	a0,a0,-474 # 62f8 <statistics+0xa56>
  ...
  if(unlink("..") == 0){
    ...
    34e8:	e9c50513          	addi	a0,a0,-356 # 7380 <statistics+0x1ade>
  ...
  if(chdir("/") != 0){
    ...
    34fa:	89250513          	addi	a0,a0,-1902 # 6d88 <statistics+0x14e6>
  ...
  if(unlink("dots/.") == 0){
    ...
    350c:	e9850513          	addi	a0,a0,-360 # 73a0 <statistics+0x1afe>
  ...
  if(unlink("dots/..") == 0){
    ...
    351e:	eae50513          	addi	a0,a0,-338 # 73c8 <statistics+0x1b26>
  ...
  if(unlink("dots") != 0){
    ...
    3530:	e0450513          	addi	a0,a0,-508 # 7330 <statistics+0x1a8e>
    ...
    354e:	dee50513          	addi	a0,a0,-530 # 7338 <statistics+0x1a96>
    ...
    356a:	dea50513          	addi	a0,a0,-534 # 7350 <statistics+0x1aae>
    ...
    3586:	de650513          	addi	a0,a0,-538 # 7368 <statistics+0x1ac6>
    ...
    35a2:	dea50513          	addi	a0,a0,-534 # 7388 <statistics+0x1ae6>
    ...
    35be:	7d650513          	addi	a0,a0,2006 # 6d90 <statistics+0x14ee>
    ...
    35da:	dd250513          	addi	a0,a0,-558 # 73a8 <statistics+0x1b06>
    ...
    35f6:	dde50513          	addi	a0,a0,-546 # 73d0 <statistics+0x1b2e>
    ...
    3612:	de250513          	addi	a0,a0,-542 # 73f0 <statistics+0x1b4e>
...
0000000000003628 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    363e:	5c650513          	addi	a0,a0,1478 # 5c00 <statistics+0x35e>
  ...
  if(chdir("dirfile") == 0){
    ...
    365a:	5aa50513          	addi	a0,a0,1450 # 5c00 <statistics+0x35e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    366e:	de650513          	addi	a0,a0,-538 # 7450 <statistics+0x1bae>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3686:	dce50513          	addi	a0,a0,-562 # 7450 <statistics+0x1bae>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    369a:	dba50513          	addi	a0,a0,-582 # 7450 <statistics+0x1bae>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36ae:	da650513          	addi	a0,a0,-602 # 7450 <statistics+0x1bae>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36c2:	d9258593          	addi	a1,a1,-622 # 7450 <statistics+0x1bae>
    36c6:	00002517          	auipc	a0,0x2
    36ca:	73250513          	addi	a0,a0,1842 # 5df8 <statistics+0x556>
  ...
  if(unlink("dirfile") != 0){
    ...
    36de:	52650513          	addi	a0,a0,1318 # 5c00 <statistics+0x35e>
  ...
  fd = open(".", O_RDWR);
    ...
    36f4:	c0850513          	addi	a0,a0,-1016 # 62f8 <statistics+0xa56>
  ...
  fd = open(".", 0);
    ...
    370a:	bf250513          	addi	a0,a0,-1038 # 62f8 <statistics+0xa56>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    371e:	5b658593          	addi	a1,a1,1462 # 5cd0 <statistics+0x42e>
  ...
  close(fd);
    ...
    374a:	cca50513          	addi	a0,a0,-822 # 7410 <statistics+0x1b6e>
    ...
    3766:	cce50513          	addi	a0,a0,-818 # 7430 <statistics+0x1b8e>
    ...
    3782:	ce250513          	addi	a0,a0,-798 # 7460 <statistics+0x1bbe>
    ...
    379e:	cc650513          	addi	a0,a0,-826 # 7460 <statistics+0x1bbe>
    ...
    37ba:	cd250513          	addi	a0,a0,-814 # 7488 <statistics+0x1be6>
    ...
    37d6:	cde50513          	addi	a0,a0,-802 # 74b0 <statistics+0x1c0e>
    ...
    37f2:	cea50513          	addi	a0,a0,-790 # 74d8 <statistics+0x1c36>
    ...
    380e:	cf650513          	addi	a0,a0,-778 # 7500 <statistics+0x1c5e>
    ...
    382a:	cfa50513          	addi	a0,a0,-774 # 7520 <statistics+0x1c7e>
    ...
    3846:	d0650513          	addi	a0,a0,-762 # 7548 <statistics+0x1ca6>
...
000000000000385c <iref>:
{
    ...
    387a:	ceaa0a13          	addi	s4,s4,-790 # 7560 <statistics+0x1cbe>
    mkdir("");
    387e:	00003497          	auipc	s1,0x3
    3882:	7ea48493          	addi	s1,s1,2026 # 7068 <statistics+0x17c6>
    link("README", "");
    3886:	00002a97          	auipc	s5,0x2
    388a:	572a8a93          	addi	s5,s5,1394 # 5df8 <statistics+0x556>
    fd = open("xx", O_CREATE);
    388e:	00004997          	auipc	s3,0x4
    3892:	bca98993          	addi	s3,s3,-1078 # 7458 <statistics+0x1bb6>
    3896:	a891                	j	38ea <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3898:	85da                	mv	a1,s6
    389a:	00004517          	auipc	a0,0x4
    389e:	cce50513          	addi	a0,a0,-818 # 7568 <statistics+0x1cc6>
    ...
    38ba:	cca50513          	addi	a0,a0,-822 # 7580 <statistics+0x1cde>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    394e:	a3698993          	addi	s3,s3,-1482 # 7380 <statistics+0x1ade>
    unlink("irefd");
    3952:	00004917          	auipc	s2,0x4
    3956:	c0e90913          	addi	s2,s2,-1010 # 7560 <statistics+0x1cbe>
    chdir("..");
    395a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3976:	41650513          	addi	a0,a0,1046 # 6d88 <statistics+0x14e6>
...
0000000000003996 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a6:	bf650513          	addi	a0,a0,-1034 # 7598 <statistics+0x1cf6>
  ...
  if(pid == 0){
    ...
    39ca:	bd250513          	addi	a0,a0,-1070 # 7598 <statistics+0x1cf6>
    ...
    39e0:	bdc50513          	addi	a0,a0,-1060 # 75b8 <statistics+0x1d16>
    ...
    39fc:	ba850513          	addi	a0,a0,-1112 # 75a0 <statistics+0x1cfe>
    ...
    3a18:	a8450513          	addi	a0,a0,-1404 # 6498 <statistics+0xbf6>
  ...
  if(unlink("oidir") != 0){
    ...
    3a46:	b5650513          	addi	a0,a0,-1194 # 7598 <statistics+0x1cf6>
    ...
    3a5a:	c3250513          	addi	a0,a0,-974 # 6688 <statistics+0xde6>
...
0000000000003a88 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a98:	b4c50513          	addi	a0,a0,-1204 # 75e0 <statistics+0x1d3e>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ac4:	b2050513          	addi	a0,a0,-1248 # 75e0 <statistics+0x1d3e>
  ...
  sleep(10); // one second
    ...
    3afc:	b6050513          	addi	a0,a0,-1184 # 6658 <statistics+0xdb6>
    ...
    3b16:	ace48493          	addi	s1,s1,-1330 # 75e0 <statistics+0x1d3e>
    3b1a:	4581                	li	a1,0
    3b1c:	8526                	mv	a0,s1
...
0000000000003b58 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b80:	adc50513          	addi	a0,a0,-1316 # 6658 <statistics+0xdb6>
  ...
  if(pid2 == 0)
    ...
    3bae:	8ee50513          	addi	a0,a0,-1810 # 6498 <statistics+0xbf6>
  ...
  if(pid3 == 0){
    ...
    3bf2:	0e258593          	addi	a1,a1,226 # 5cd0 <statistics+0x42e>
    ...
    3c1c:	88050513          	addi	a0,a0,-1920 # 6498 <statistics+0xbf6>
    ...
    3c36:	9be50513          	addi	a0,a0,-1602 # 75f0 <statistics+0x1d4e>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c56:	b9e58593          	addi	a1,a1,-1122 # b7f0 <buf>
    ...
    3c70:	99c50513          	addi	a0,a0,-1636 # 7608 <statistics+0x1d66>
  ...
  printf("kill... ");
    ...
    3c9c:	98850513          	addi	a0,a0,-1656 # 7620 <statistics+0x1d7e>
  ...
  printf("wait... ");
    ...
    3cca:	96a50513          	addi	a0,a0,-1686 # 7630 <statistics+0x1d8e>
...
0000000000003cf6 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d2c:	87850513          	addi	a0,a0,-1928 # 65a0 <statistics+0xcfe>
    ...
    3d62:	f7258593          	addi	a1,a1,-142 # 5cd0 <statistics+0x42e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e26:	81e50513          	addi	a0,a0,-2018 # 7640 <statistics+0x1d9e>
    ...
    3e42:	65a50513          	addi	a0,a0,1626 # 6498 <statistics+0xbf6>
    ...
    3e8c:	7d850513          	addi	a0,a0,2008 # 7660 <statistics+0x1dbe>
...
0000000000003eac <reparent>:
{
  ...
  exit(0);
    ...
    3f00:	59c50513          	addi	a0,a0,1436 # 6498 <statistics+0xbf6>
    ...
    3f1c:	70850513          	addi	a0,a0,1800 # 6620 <statistics+0xd7e>
...
0000000000003f5c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3fc4:	6d050513          	addi	a0,a0,1744 # 7690 <statistics+0x1dee>
...
0000000000004002 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4098:	61c50513          	addi	a0,a0,1564 # 76b0 <statistics+0x1e0e>
    ...
    40b4:	62850513          	addi	a0,a0,1576 # 76d8 <statistics+0x1e36>
  ...
  fd = open("sharedfd", 0);
    ...
    40f8:	9b450513          	addi	a0,a0,-1612 # 5aa8 <statistics+0x206>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4138:	5c450513          	addi	a0,a0,1476 # 76f8 <statistics+0x1e56>
    ...
    4152:	fd2783e3          	beq	a5,s2,4118 <sharedfd+0x116>
      if(buf[i] == 'c')
    4156:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1800>
  ...
  unlink("sharedfd");
    ...
    4174:	93850513          	addi	a0,a0,-1736 # 5aa8 <statistics+0x206>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    419a:	58a50513          	addi	a0,a0,1418 # 7720 <statistics+0x1e7e>
...
00000000000041ba <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41de:	74e78793          	addi	a5,a5,1870 # 5928 <statistics+0x86>
    41e2:	f6f43823          	sd	a5,-144(s0)
    41e6:	00001797          	auipc	a5,0x1
    41ea:	74a78793          	addi	a5,a5,1866 # 5930 <statistics+0x8e>
    41ee:	f6f43c23          	sd	a5,-136(s0)
    41f2:	00001797          	auipc	a5,0x1
    41f6:	74678793          	addi	a5,a5,1862 # 5938 <statistics+0x96>
    41fa:	f8f43023          	sd	a5,-128(s0)
    41fe:	00001797          	auipc	a5,0x1
    4202:	74278793          	addi	a5,a5,1858 # 5940 <statistics+0x9e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    425c:	598a0a13          	addi	s4,s4,1432 # b7f0 <buf>
    4260:	00007a97          	auipc	s5,0x7
    4264:	591a8a93          	addi	s5,s5,1425 # b7f1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    427a:	61250513          	addi	a0,a0,1554 # 6888 <statistics+0xfe6>
    ...
    42f4:	44850513          	addi	a0,a0,1096 # 7738 <statistics+0x1e96>
    ...
    430e:	43e50513          	addi	a0,a0,1086 # 7748 <statistics+0x1ea6>
    ...
    4332:	43250513          	addi	a0,a0,1074 # 7760 <statistics+0x1ebe>
    ...
    4362:	49278793          	addi	a5,a5,1170 # b7f0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43c2:	3b250513          	addi	a0,a0,946 # 7770 <statistics+0x1ece>
...
00000000000043f6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4424:	368b8b93          	addi	s7,s7,872 # 7788 <statistics+0x1ee6>
  for(i = 0; i < N; i++){
    ...
    4466:	32e50513          	addi	a0,a0,814 # 7790 <statistics+0x1eee>
    ...
    4484:	30850513          	addi	a0,a0,776 # 7788 <statistics+0x1ee6>
  ...
  fd = open(".", 0);
    ...
    44bc:	e4050513          	addi	a0,a0,-448 # 62f8 <statistics+0xa56>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    44e2:	2d250513          	addi	a0,a0,722 # 77b0 <statistics+0x1f0e>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4552:	28250513          	addi	a0,a0,642 # 77d0 <statistics+0x1f2e>
  ...
  for(i = 0; i < N; i++){
    ...
    458a:	27250513          	addi	a0,a0,626 # 77f8 <statistics+0x1f56>
    ...
    45a6:	ef650513          	addi	a0,a0,-266 # 6498 <statistics+0xbf6>
...
0000000000004750 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4790:	06490913          	addi	s2,s2,100 # b7f0 <buf>
  for(i = 0; i < N; i++){
    4794:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d8:	05c50513          	addi	a0,a0,92 # 7830 <statistics+0x1f8e>
  ...
  for(i = 0; ; i++){
    ...
    47ee:	00690913          	addi	s2,s2,6 # b7f0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    483c:	00850513          	addi	a0,a0,8 # 7840 <statistics+0x1f9e>
    ...
    4858:	00c50513          	addi	a0,a0,12 # 7860 <statistics+0x1fbe>
    ...
    4874:	01050513          	addi	a0,a0,16 # 7880 <statistics+0x1fde>
    ...
    4890:	01450513          	addi	a0,a0,20 # 78a0 <statistics+0x1ffe>
    ...
    48ac:	01850513          	addi	a0,a0,24 # 78c0 <statistics+0x201e>
    ...
    48c8:	01450513          	addi	a0,a0,20 # 78d8 <statistics+0x2036>
  ...
  unlink("bigfile.dat");
    ...
    48f6:	f3e50513          	addi	a0,a0,-194 # 7830 <statistics+0x1f8e>
    ...
    491a:	fe250513          	addi	a0,a0,-30 # 78f8 <statistics+0x2056>
...
0000000000004930 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    4940:	fdc50513          	addi	a0,a0,-36 # 7918 <statistics+0x2076>
  ...
  if(chdir("dir0") < 0){
    ...
    4964:	fc850513          	addi	a0,a0,-56 # 7928 <statistics+0x2086>
  ...
  if(chdir("..") < 0){
    ...
    4978:	a0c50513          	addi	a0,a0,-1524 # 7380 <statistics+0x1ade>
  ...
  if(unlink("dir0") < 0){
    ...
    498c:	fa050513          	addi	a0,a0,-96 # 7928 <statistics+0x2086>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49a0:	fdc50513          	addi	a0,a0,-36 # 7978 <statistics+0x20d6>
    ...
    49bc:	36850513          	addi	a0,a0,872 # 6d20 <statistics+0x147e>
    ...
    49d8:	f5c50513          	addi	a0,a0,-164 # 7930 <statistics+0x208e>
    ...
    49f4:	f5850513          	addi	a0,a0,-168 # 7948 <statistics+0x20a6>
    ...
    4a10:	f5450513          	addi	a0,a0,-172 # 7960 <statistics+0x20be>
...
0000000000004a26 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a48:	f4c50513          	addi	a0,a0,-180 # 7990 <statistics+0x20ee>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4a68:	f3cc8c93          	addi	s9,s9,-196 # 79a0 <statistics+0x20fe>
    int total = 0;
    4a6c:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4a6e:	00007a17          	auipc	s4,0x7
    4a72:	d82a0a13          	addi	s4,s4,-638 # b7f0 <buf>
    name[0] = 'f';
    ...
    4ae2:	ed250513          	addi	a0,a0,-302 # 79b0 <statistics+0x210e>
  ...
  printf("fsfull test finished\n");
    ...
    4b58:	e8c50513          	addi	a0,a0,-372 # 79e0 <statistics+0x213e>
    ...
    4ba8:	e2450513          	addi	a0,a0,-476 # 79c8 <statistics+0x2126>
...
0000000000004bc6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bd0:	3f470713          	addi	a4,a4,1012 # 7fc0 <randstate>
    4bd4:	6308                	ld	a0,0(a4)
    4bd6:	001967b7          	lui	a5,0x196
    4bda:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187e0d>
    4bde:	02f50533          	mul	a0,a0,a5
    4be2:	3c6ef7b7          	lui	a5,0x3c6ef
    4be6:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0b5f>
...
0000000000004bf6 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c6a:	d9250513          	addi	a0,a0,-622 # 79f8 <statistics+0x2156>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c82:	05258593          	addi	a1,a1,82 # 5cd0 <statistics+0x42e>
    ...
    4c98:	d8450513          	addi	a0,a0,-636 # 7a18 <statistics+0x2176>
    ...
    4cb2:	d5250513          	addi	a0,a0,-686 # 7a00 <statistics+0x215e>
    ...
    4ccc:	d3850513          	addi	a0,a0,-712 # 7a00 <statistics+0x215e>
  ...
  unlink("junk");
    ...
    4cf0:	d0c50513          	addi	a0,a0,-756 # 79f8 <statistics+0x2156>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d46:	f8e90913          	addi	s2,s2,-114 # 5cd0 <statistics+0x42e>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d7a:	cf250513          	addi	a0,a0,-782 # 7a68 <statistics+0x21c6>
    ...
    4d94:	c9850513          	addi	a0,a0,-872 # 7a28 <statistics+0x2186>
    ...
    4dae:	c9e50513          	addi	a0,a0,-866 # 7a48 <statistics+0x21a6>
  ...
  while(1){
    ...
    4dfc:	c9050513          	addi	a0,a0,-880 # 7a88 <statistics+0x21e6>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e4c:	c6050513          	addi	a0,a0,-928 # 7aa8 <statistics+0x2206>
  ...
  if(pid == 0) {
    ...
    4e7c:	c5850513          	addi	a0,a0,-936 # 7ad0 <statistics+0x222e>
    ...
    4ea0:	c1c50513          	addi	a0,a0,-996 # 7ab8 <statistics+0x2216>
    ...
    4ec8:	c1450513          	addi	a0,a0,-1004 # 7ad8 <statistics+0x2236>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f10:	ce478793          	addi	a5,a5,-796 # 7bf0 <statistics+0x234e>
    4f14:	c4040713          	addi	a4,s0,-960
    4f18:	00003817          	auipc	a6,0x3
    4f1c:	05880813          	addi	a6,a6,88 # 7f70 <statistics+0x26ce>
  ...
  printf("usertests starting\n");
    ...
    4f40:	c5450513          	addi	a0,a0,-940 # 7b90 <statistics+0x22ee>
  ...
  if(fail){
    ...
    4f78:	bd450513          	addi	a0,a0,-1068 # 7b48 <statistics+0x22a6>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f94:	b5058593          	addi	a1,a1,-1200 # 7ae0 <statistics+0x223e>
    ...
    4faa:	c2258593          	addi	a1,a1,-990 # 7bc8 <statistics+0x2326>
    ...
    4fce:	b1e50513          	addi	a0,a0,-1250 # 7ae8 <statistics+0x2246>
  ...
  if(fail){
    ...
    503a:	afa50513          	addi	a0,a0,-1286 # 7b30 <statistics+0x228e>
    ...
    5054:	b2850513          	addi	a0,a0,-1240 # 7b78 <statistics+0x22d6>
    ...
    50b2:	b4278793          	addi	a5,a5,-1214 # 7bf0 <statistics+0x234e>
    50b6:	c4040713          	addi	a4,s0,-960
    50ba:	00003817          	auipc	a6,0x3
    50be:	eb680813          	addi	a6,a6,-330 # 7f70 <statistics+0x26ce>
    ...
    50e2:	aca50513          	addi	a0,a0,-1334 # 7ba8 <statistics+0x2306>
    50e6:	00000097          	auipc	ra,0x0
    50ea:	61a080e7          	jalr	1562(ra) # 5700 <printf>
        printf("SOME TESTS FAILED\n");
    50ee:	00003a97          	auipc	s5,0x3
    50f2:	a42a8a93          	addi	s5,s5,-1470 # 7b30 <statistics+0x228e>
        if(continuous != 2)
    50f6:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f8:	00003b17          	auipc	s6,0x3
    50fc:	a18b0b13          	addi	s6,s6,-1512 # 7b10 <statistics+0x226e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5470:	b0c50513          	addi	a0,a0,-1268 # 7f78 <digits>
    5474:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    553c:	a40b8b93          	addi	s7,s7,-1472 # 7f78 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    567c:	8f890913          	addi	s2,s2,-1800 # 7f70 <statistics+0x26ce>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5744:	8907b783          	ld	a5,-1904(a5) # 7fd0 <freep>
    ...
    5772:	00e6ea63          	bltu	a3,a4,5786 <free+0x50>
{
  ...
  freep = p;
    ...
    57b4:	82f73023          	sd	a5,-2016(a4) # 7fd0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    57e6:	7ee53503          	ld	a0,2030(a0) # 7fd0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    580e:	7c690913          	addi	s2,s2,1990 # 7fd0 <freep>
  if(p == (char*)-1)
    5812:	5afd                	li	s5,-1
    5814:	a88d                	j	5886 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5816:	00009797          	auipc	a5,0x9
    581a:	fda78793          	addi	a5,a5,-38 # e7f0 <base>
    581e:	00002717          	auipc	a4,0x2
    5822:	7af73923          	sd	a5,1970(a4) # 7fd0 <freep>
    ...
    5848:	78a73623          	sd	a0,1932(a4) # 7fd0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
  ...
  fd = open("statistics", O_RDONLY);
    ...
    58bc:	6d850513          	addi	a0,a0,1752 # 7f90 <digits+0x18>
    58c0:	00000097          	auipc	ra,0x0
    58c4:	af8080e7          	jalr	-1288(ra) # 53b8 <open>
  if(fd < 0) {
  ...
  for (i = 0; i < sz; ) {
    ...
    58e2:	ab2080e7          	jalr	-1358(ra) # 5390 <read>
  ...
  close(fd);
    ...
    58f6:	aae080e7          	jalr	-1362(ra) # 53a0 <close>
  return i;
}
    58fa:	8526                	mv	a0,s1
    ...
    5910:	69458593          	addi	a1,a1,1684 # 7fa0 <digits+0x28>
    5914:	4509                	li	a0,2
    ...
    5924:	a58080e7          	jalr	-1448(ra) # 5378 <exit>
