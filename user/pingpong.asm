...
main(void)
{
  ...
  if (pid < 0) {
  28:	06054563          	bltz	a0,92 <main+0x92>
    fprintf(2, "fork failed\n");
    exit(1);
  }

  if (pid == 0) {
  2c:	e149                	bnez	a0,ae <main+0xae>
    // 子进程
    char buf[1];
  ...
  36:	37e080e7          	jalr	894(ra) # 3b0 <close>
    close(p2[0]);
  3a:	fe042503          	lw	a0,-32(s0)
  3e:	00000097          	auipc	ra,0x0
  42:	372080e7          	jalr	882(ra) # 3b0 <close>
  ...
  54:	350080e7          	jalr	848(ra) # 3a0 <read>
    // 打印 "<child_pid>: received ping"
    printf("%d: received ping\n", getpid());
  58:	00000097          	auipc	ra,0x0
  5c:	3b0080e7          	jalr	944(ra) # 408 <getpid>
  60:	85aa                	mv	a1,a0
  62:	00001517          	auipc	a0,0x1
  66:	86650513          	addi	a0,a0,-1946 # 8c8 <malloc+0xfa>
  6a:	00000097          	auipc	ra,0x0
  6e:	6a6080e7          	jalr	1702(ra) # 710 <printf>

    // 将任意一个字节写回给父进程
    write(p2[1], "x", 1);
  72:	4605                	li	a2,1
  74:	00001597          	auipc	a1,0x1
  78:	86c58593          	addi	a1,a1,-1940 # 8e0 <malloc+0x112>
  7c:	fe442503          	lw	a0,-28(s0)
  80:	00000097          	auipc	ra,0x0
  84:	328080e7          	jalr	808(ra) # 3a8 <write>

    exit(0);
  88:	4501                	li	a0,0
  8a:	00000097          	auipc	ra,0x0
  8e:	2fe080e7          	jalr	766(ra) # 388 <exit>
    fprintf(2, "fork failed\n");
  92:	00001597          	auipc	a1,0x1
  96:	82658593          	addi	a1,a1,-2010 # 8b8 <malloc+0xea>
  9a:	4509                	li	a0,2
  9c:	00000097          	auipc	ra,0x0
  a0:	646080e7          	jalr	1606(ra) # 6e2 <fprintf>
    exit(1);
  a4:	4505                	li	a0,1
  a6:	00000097          	auipc	ra,0x0
  aa:	2e2080e7          	jalr	738(ra) # 388 <exit>
    ...
    close(p1[0]);
  ae:	fe842503          	lw	a0,-24(s0)
  b2:	00000097          	auipc	ra,0x0
  b6:	2fe080e7          	jalr	766(ra) # 3b0 <close>
    close(p2[1]);
  ba:	fe442503          	lw	a0,-28(s0)
  be:	00000097          	auipc	ra,0x0
  c2:	2f2080e7          	jalr	754(ra) # 3b0 <close>

    // 向子进程发送一个字节
    write(p1[1], "y", 1);
  c6:	4605                	li	a2,1
  c8:	00001597          	auipc	a1,0x1
  cc:	82058593          	addi	a1,a1,-2016 # 8e8 <malloc+0x11a>
  d0:	fec42503          	lw	a0,-20(s0)
  d4:	00000097          	auipc	ra,0x0
  d8:	2d4080e7          	jalr	724(ra) # 3a8 <write>
    // 读子进程发回的字节
    read(p2[0], buf, 1);
  dc:	4605                	li	a2,1
  de:	fd840593          	addi	a1,s0,-40
  e2:	fe042503          	lw	a0,-32(s0)
  e6:	00000097          	auipc	ra,0x0
  ea:	2ba080e7          	jalr	698(ra) # 3a0 <read>

    // 打印 "<parent_pid>: received pong"
    printf("%d: received pong\n", getpid());
  ee:	00000097          	auipc	ra,0x0
  f2:	31a080e7          	jalr	794(ra) # 408 <getpid>
  f6:	85aa                	mv	a1,a0
  f8:	00000517          	auipc	a0,0x0
  fc:	7f850513          	addi	a0,a0,2040 # 8f0 <malloc+0x122>
 100:	00000097          	auipc	ra,0x0
 104:	610080e7          	jalr	1552(ra) # 710 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 480:	49450513          	addi	a0,a0,1172 # 910 <digits>
 484:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	3c8b8b93          	addi	s7,s7,968 # 910 <digits>
 ...
 68c:	28090913          	addi	s2,s2,640 # 908 <malloc+0x13a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 754:	1d87b783          	ld	a5,472(a5) # 928 <freep>
 ...
 782:	00e6ea63          	bltu	a3,a4,796 <free+0x50>
{
 ...
 7c4:	16f73423          	sd	a5,360(a4) # 928 <freep>
}
 7c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f6:	13653503          	ld	a0,310(a0) # 928 <freep>
 ...
 81e:	10e90913          	addi	s2,s2,270 # 928 <freep>
  if(p == (char*)-1)
 822:	5afd                	li	s5,-1
 824:	a88d                	j	896 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 826:	00000797          	auipc	a5,0x0
 82a:	10a78793          	addi	a5,a5,266 # 930 <base>
 82e:	00000717          	auipc	a4,0x0
 832:	0ef73d23          	sd	a5,250(a4) # 928 <freep>
 836:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 858:	0ca73a23          	sd	a0,212(a4) # 928 <freep>
      return (void*)(p + 1);
