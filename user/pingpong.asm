...
main(void)
{
  ...
  66:	85e50513          	addi	a0,a0,-1954 # 8c0 <malloc+0xfa>
  6a:	00000097          	auipc	ra,0x0
  6e:	69e080e7          	jalr	1694(ra) # 708 <printf>

    // 将任意一个字节写回给父进程
    write(p2[1], "x", 1);
  72:	4605                	li	a2,1
  74:	00001597          	auipc	a1,0x1
  78:	86458593          	addi	a1,a1,-1948 # 8d8 <malloc+0x112>
  ...
  96:	81e58593          	addi	a1,a1,-2018 # 8b0 <malloc+0xea>
  9a:	4509                	li	a0,2
  9c:	00000097          	auipc	ra,0x0
  a0:	63e080e7          	jalr	1598(ra) # 6da <fprintf>
    exit(1);
  a4:	4505                	li	a0,1
  ...
  cc:	81858593          	addi	a1,a1,-2024 # 8e0 <malloc+0x11a>
  ...
  fc:	7f050513          	addi	a0,a0,2032 # 8e8 <malloc+0x122>
 100:	00000097          	auipc	ra,0x0
 104:	608080e7          	jalr	1544(ra) # 708 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 478:	49450513          	addi	a0,a0,1172 # 908 <digits>
 47c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 544:	3c8b8b93          	addi	s7,s7,968 # 908 <digits>
 ...
 684:	28090913          	addi	s2,s2,640 # 900 <malloc+0x13a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74c:	1d87b783          	ld	a5,472(a5) # 920 <freep>
 ...
 77a:	00e6ea63          	bltu	a3,a4,78e <free+0x50>
{
 ...
 7bc:	16f73423          	sd	a5,360(a4) # 920 <freep>
}
 7c0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ee:	13653503          	ld	a0,310(a0) # 920 <freep>
 ...
 816:	10e90913          	addi	s2,s2,270 # 920 <freep>
  if(p == (char*)-1)
 81a:	5afd                	li	s5,-1
 81c:	a88d                	j	88e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 81e:	00000797          	auipc	a5,0x0
 822:	10a78793          	addi	a5,a5,266 # 928 <base>
 826:	00000717          	auipc	a4,0x0
 82a:	0ef73d23          	sd	a5,250(a4) # 920 <freep>
 82e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 850:	0ca73a23          	sd	a0,212(a4) # 920 <freep>
      return (void*)(p + 1);
