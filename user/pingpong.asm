...
main(void)
{
  ...
  66:	85650513          	addi	a0,a0,-1962 # 8b8 <malloc+0xfa>
  6a:	00000097          	auipc	ra,0x0
  6e:	696080e7          	jalr	1686(ra) # 700 <printf>

    // 将任意一个字节写回给父进程
    write(p2[1], "x", 1);
  72:	4605                	li	a2,1
  74:	00001597          	auipc	a1,0x1
  78:	85c58593          	addi	a1,a1,-1956 # 8d0 <malloc+0x112>
  ...
  96:	81658593          	addi	a1,a1,-2026 # 8a8 <malloc+0xea>
  9a:	4509                	li	a0,2
  9c:	00000097          	auipc	ra,0x0
  a0:	636080e7          	jalr	1590(ra) # 6d2 <fprintf>
    exit(1);
  a4:	4505                	li	a0,1
  ...
  cc:	81058593          	addi	a1,a1,-2032 # 8d8 <malloc+0x11a>
  ...
  fc:	7e850513          	addi	a0,a0,2024 # 8e0 <malloc+0x122>
 100:	00000097          	auipc	ra,0x0
 104:	600080e7          	jalr	1536(ra) # 700 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 470:	49450513          	addi	a0,a0,1172 # 900 <digits>
 474:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53c:	3c8b8b93          	addi	s7,s7,968 # 900 <digits>
 ...
 67c:	28090913          	addi	s2,s2,640 # 8f8 <malloc+0x13a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 744:	1d87b783          	ld	a5,472(a5) # 918 <freep>
 ...
 772:	00e6ea63          	bltu	a3,a4,786 <free+0x50>
{
 ...
 7b4:	16f73423          	sd	a5,360(a4) # 918 <freep>
}
 7b8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7e6:	13653503          	ld	a0,310(a0) # 918 <freep>
 ...
 80e:	10e90913          	addi	s2,s2,270 # 918 <freep>
  if(p == (char*)-1)
 812:	5afd                	li	s5,-1
 814:	a88d                	j	886 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 816:	00000797          	auipc	a5,0x0
 81a:	10a78793          	addi	a5,a5,266 # 920 <base>
 81e:	00000717          	auipc	a4,0x0
 822:	0ef73d23          	sd	a5,250(a4) # 918 <freep>
 826:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 848:	0ca73a23          	sd	a0,212(a4) # 918 <freep>
      return (void*)(p + 1);
