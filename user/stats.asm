...
main(void)
{
  ...
  16:	8d6a0a13          	addi	s4,s4,-1834 # 8e8 <buf>
  1a:	00001a97          	auipc	s5,0x1
  1e:	8cfa8a93          	addi	s5,s5,-1841 # 8e9 <buf+0x1>
  ...
  32:	7e2080e7          	jalr	2018(ra) # 810 <statistics>
  36:	89aa                	mv	s3,a0
    for (i = 0; i < n; i++) {
  38:	fea056e3          	blez	a0,24 <main+0x24>
  3c:	00001497          	auipc	s1,0x1
  40:	8ac48493          	addi	s1,s1,-1876 # 8e8 <buf>
...
strcpy(char *s, const char *t)
{
  ...
  7c:	fff5c703          	lbu	a4,-1(a1) # fff <buf+0x717>
  80:	fee78fa3          	sb	a4,-1(a5) # fff <buf+0x717>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ea:	2b290913          	addi	s2,s2,690 # 898 <statistics+0x88>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b2:	2327b783          	ld	a5,562(a5) # 8e0 <freep>
...
malloc(uint nbytes)
{
 ...
 788:	16478793          	addi	a5,a5,356 # 18e8 <base>
 78c:	00000717          	auipc	a4,0x0
 790:	14f73a23          	sd	a5,340(a4) # 8e0 <freep>
 794:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b6:	12a73723          	sd	a0,302(a4) # 8e0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 82a:	09250513          	addi	a0,a0,146 # 8b8 <digits+0x18>
 82e:	00000097          	auipc	ra,0x0
 832:	af8080e7          	jalr	-1288(ra) # 326 <open>
  if(fd < 0) {
 ...
 850:	ab2080e7          	jalr	-1358(ra) # 2fe <read>
 ...
 864:	aae080e7          	jalr	-1362(ra) # 30e <close>
  return i;
}
 868:	8526                	mv	a0,s1
 ...
 87e:	04e58593          	addi	a1,a1,78 # 8c8 <digits+0x28>
 882:	4509                	li	a0,2
 884:	00000097          	auipc	ra,0x0
 888:	dbc080e7          	jalr	-580(ra) # 640 <fprintf>
      exit(1);
 88c:	4505                	li	a0,1
 88e:	00000097          	auipc	ra,0x0
 892:	a58080e7          	jalr	-1448(ra) # 2e6 <exit>
