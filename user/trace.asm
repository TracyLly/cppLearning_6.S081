...
main(int argc, char *argv[])
{
  ...
  32:	8ba58593          	addi	a1,a1,-1862 # 8e8 <statistics+0x88>
  36:	4509                	li	a0,2
  ...
  a8:	85c58593          	addi	a1,a1,-1956 # 900 <statistics+0xa0>
  ac:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	4f650513          	addi	a0,a0,1270 # 920 <digits>
 432:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	42ab8b93          	addi	s7,s7,1066 # 920 <digits>
 ...
 63a:	2e290913          	addi	s2,s2,738 # 918 <statistics+0xb8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 702:	2627b783          	ld	a5,610(a5) # 960 <freep>
 ...
 730:	00e6ea63          	bltu	a3,a4,744 <free+0x50>
{
 ...
 772:	1ef73923          	sd	a5,498(a4) # 960 <freep>
}
 776:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a4:	1c053503          	ld	a0,448(a0) # 960 <freep>
 ...
 7cc:	19890913          	addi	s2,s2,408 # 960 <freep>
  if(p == (char*)-1)
 7d0:	5afd                	li	s5,-1
 7d2:	a88d                	j	844 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7d4:	00000797          	auipc	a5,0x0
 7d8:	19478793          	addi	a5,a5,404 # 968 <base>
 ...
 806:	14a73f23          	sd	a0,350(a4) # 960 <freep>
      return (void*)(p + 1);
...
{
 860:	7179                	addi	sp,sp,-48
 862:	f406                	sd	ra,40(sp)
 864:	f022                	sd	s0,32(sp)
 866:	ec26                	sd	s1,24(sp)
 ...
 87a:	0c250513          	addi	a0,a0,194 # 938 <digits+0x18>
 87e:	00000097          	auipc	ra,0x0
 882:	af8080e7          	jalr	-1288(ra) # 376 <open>
  if(fd < 0) {
 886:	04054263          	bltz	a0,8ca <statistics+0x6a>
 88a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 88c:	4481                	li	s1,0
 88e:	03205063          	blez	s2,8ae <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 892:	4099063b          	subw	a2,s2,s1
 896:	009a05b3          	add	a1,s4,s1
 89a:	854e                	mv	a0,s3
 89c:	00000097          	auipc	ra,0x0
 8a0:	ab2080e7          	jalr	-1358(ra) # 34e <read>
 8a4:	00054563          	bltz	a0,8ae <statistics+0x4e>
      break;
    }
    i += n;
 8a8:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8aa:	ff24c4e3          	blt	s1,s2,892 <statistics+0x32>
  }
  close(fd);
 8ae:	854e                	mv	a0,s3
 8b0:	00000097          	auipc	ra,0x0
 8b4:	aae080e7          	jalr	-1362(ra) # 35e <close>
  return i;
}
 8b8:	8526                	mv	a0,s1
 ...
 8c8:	8082                	ret
      fprintf(2, "stats: open failed\n");
 8ca:	00000597          	auipc	a1,0x0
 8ce:	07e58593          	addi	a1,a1,126 # 948 <digits+0x28>
 8d2:	4509                	li	a0,2
 8d4:	00000097          	auipc	ra,0x0
 8d8:	dbc080e7          	jalr	-580(ra) # 690 <fprintf>
      exit(1);
 8dc:	4505                	li	a0,1
 8de:	00000097          	auipc	ra,0x0
 8e2:	a58080e7          	jalr	-1448(ra) # 336 <exit>
