...
main(int argc, char **argv)
{
  ...
  4c:	84858593          	addi	a1,a1,-1976 # 890 <statistics+0x8c>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	4e250513          	addi	a0,a0,1250 # 8b0 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	416b8b93          	addi	s7,s7,1046 # 8b0 <digits>
 ...
 5de:	2ce90913          	addi	s2,s2,718 # 8a8 <statistics+0xa4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	24e7b783          	ld	a5,590(a5) # 8f0 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x50>
{
 ...
 716:	1cf73f23          	sd	a5,478(a4) # 8f0 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 748:	1ac53503          	ld	a0,428(a0) # 8f0 <freep>
 ...
 770:	18490913          	addi	s2,s2,388 # 8f0 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 776:	a88d                	j	7e8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 778:	00000797          	auipc	a5,0x0
 77c:	18078793          	addi	a5,a5,384 # 8f8 <base>
 ...
 7aa:	14a73523          	sd	a0,330(a4) # 8f0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 81e:	0ae50513          	addi	a0,a0,174 # 8c8 <digits+0x18>
 822:	00000097          	auipc	ra,0x0
 826:	af8080e7          	jalr	-1288(ra) # 31a <open>
  if(fd < 0) {
 ...
 844:	ab2080e7          	jalr	-1358(ra) # 2f2 <read>
 ...
 858:	aae080e7          	jalr	-1362(ra) # 302 <close>
  return i;
}
 85c:	8526                	mv	a0,s1
 ...
 872:	06a58593          	addi	a1,a1,106 # 8d8 <digits+0x28>
 876:	4509                	li	a0,2
 878:	00000097          	auipc	ra,0x0
 87c:	dbc080e7          	jalr	-580(ra) # 634 <fprintf>
      exit(1);
 880:	4505                	li	a0,1
 882:	00000097          	auipc	ra,0x0
 886:	a58080e7          	jalr	-1448(ra) # 2da <exit>
