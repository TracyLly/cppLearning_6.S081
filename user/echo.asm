...
main(int argc, char *argv[])
{
  ...
  2e:	886a0a13          	addi	s4,s4,-1914 # 8b0 <statistics+0x8c>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	85058593          	addi	a1,a1,-1968 # 8b8 <statistics+0x94>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	4da50513          	addi	a0,a0,1242 # 8c8 <digits>
 3f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	40eb8b93          	addi	s7,s7,1038 # 8c8 <digits>
 ...
 5fe:	2c690913          	addi	s2,s2,710 # 8c0 <statistics+0x9c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c6:	2467b783          	ld	a5,582(a5) # 908 <freep>
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x50>
{
 ...
 736:	1cf73b23          	sd	a5,470(a4) # 908 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	1a453503          	ld	a0,420(a0) # 908 <freep>
 ...
 790:	17c90913          	addi	s2,s2,380 # 908 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 796:	a88d                	j	808 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 798:	00000797          	auipc	a5,0x0
 79c:	17878793          	addi	a5,a5,376 # 910 <base>
 ...
 7ca:	14a73123          	sd	a0,322(a4) # 908 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 83e:	0a650513          	addi	a0,a0,166 # 8e0 <digits+0x18>
 842:	00000097          	auipc	ra,0x0
 846:	af8080e7          	jalr	-1288(ra) # 33a <open>
  if(fd < 0) {
 84a:	04054263          	bltz	a0,88e <statistics+0x6a>
 84e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 850:	4481                	li	s1,0
 852:	03205063          	blez	s2,872 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 856:	4099063b          	subw	a2,s2,s1
 85a:	009a05b3          	add	a1,s4,s1
 85e:	854e                	mv	a0,s3
 860:	00000097          	auipc	ra,0x0
 864:	ab2080e7          	jalr	-1358(ra) # 312 <read>
 868:	00054563          	bltz	a0,872 <statistics+0x4e>
      break;
    }
    i += n;
 86c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 86e:	ff24c4e3          	blt	s1,s2,856 <statistics+0x32>
  }
  close(fd);
 872:	854e                	mv	a0,s3
 874:	00000097          	auipc	ra,0x0
 878:	aae080e7          	jalr	-1362(ra) # 322 <close>
  return i;
}
 87c:	8526                	mv	a0,s1
 87e:	70a2                	ld	ra,40(sp)
 880:	7402                	ld	s0,32(sp)
 882:	64e2                	ld	s1,24(sp)
 ...
 892:	06258593          	addi	a1,a1,98 # 8f0 <digits+0x28>
 896:	4509                	li	a0,2
 898:	00000097          	auipc	ra,0x0
 89c:	dbc080e7          	jalr	-580(ra) # 654 <fprintf>
      exit(1);
 8a0:	4505                	li	a0,1
 8a2:	00000097          	auipc	ra,0x0
 8a6:	a58080e7          	jalr	-1448(ra) # 2fa <exit>
