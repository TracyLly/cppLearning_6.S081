...
wc(int fd, char *name)
{
  ...
  3c:	988a0a13          	addi	s4,s4,-1656 # 9c0 <statistics+0x8a>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	92250513          	addi	a0,a0,-1758 # 9d8 <statistics+0xa2>
  ...
  e8:	8e450513          	addi	a0,a0,-1820 # 9c8 <statistics+0x92>
...
main(int argc, char *argv[])
{
 ...
 162:	88a58593          	addi	a1,a1,-1910 # 9e8 <statistics+0xb2>
 166:	4501                	li	a0,0
 ...
 180:	87450513          	addi	a0,a0,-1932 # 9f0 <statistics+0xba>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 504:	51050513          	addi	a0,a0,1296 # a10 <digits>
 508:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d0:	444b8b93          	addi	s7,s7,1092 # a10 <digits>
 ...
 710:	2fc90913          	addi	s2,s2,764 # a08 <statistics+0xd2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7d8:	27c7b783          	ld	a5,636(a5) # a50 <freep>
 ...
 806:	00e6ea63          	bltu	a3,a4,81a <free+0x50>
{
 ...
 848:	20f73623          	sd	a5,524(a4) # a50 <freep>
}
 84c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 87a:	1da53503          	ld	a0,474(a0) # a50 <freep>
 ...
 8a2:	1b290913          	addi	s2,s2,434 # a50 <freep>
  if(p == (char*)-1)
 8a6:	5afd                	li	s5,-1
 8a8:	a88d                	j	91a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8aa:	00000797          	auipc	a5,0x0
 8ae:	3ae78793          	addi	a5,a5,942 # c58 <base>
 8b2:	00000717          	auipc	a4,0x0
 8b6:	18f73f23          	sd	a5,414(a4) # a50 <freep>
 8ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8dc:	16a73c23          	sd	a0,376(a4) # a50 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 950:	0dc50513          	addi	a0,a0,220 # a28 <digits+0x18>
 954:	00000097          	auipc	ra,0x0
 958:	af8080e7          	jalr	-1288(ra) # 44c <open>
  if(fd < 0) {
 95c:	04054263          	bltz	a0,9a0 <statistics+0x6a>
 960:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 962:	4481                	li	s1,0
 964:	03205063          	blez	s2,984 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 968:	4099063b          	subw	a2,s2,s1
 96c:	009a05b3          	add	a1,s4,s1
 970:	854e                	mv	a0,s3
 972:	00000097          	auipc	ra,0x0
 976:	ab2080e7          	jalr	-1358(ra) # 424 <read>
 97a:	00054563          	bltz	a0,984 <statistics+0x4e>
      break;
    }
    i += n;
 97e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 980:	ff24c4e3          	blt	s1,s2,968 <statistics+0x32>
  }
  close(fd);
 984:	854e                	mv	a0,s3
 986:	00000097          	auipc	ra,0x0
 98a:	aae080e7          	jalr	-1362(ra) # 434 <close>
  return i;
}
 98e:	8526                	mv	a0,s1
 990:	70a2                	ld	ra,40(sp)
 992:	7402                	ld	s0,32(sp)
 994:	64e2                	ld	s1,24(sp)
 996:	6942                	ld	s2,16(sp)
 998:	69a2                	ld	s3,8(sp)
 99a:	6a02                	ld	s4,0(sp)
 99c:	6145                	addi	sp,sp,48
 99e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 9a0:	00000597          	auipc	a1,0x0
 9a4:	09858593          	addi	a1,a1,152 # a38 <digits+0x28>
 9a8:	4509                	li	a0,2
 9aa:	00000097          	auipc	ra,0x0
 9ae:	dbc080e7          	jalr	-580(ra) # 766 <fprintf>
      exit(1);
 9b2:	4505                	li	a0,1
 9b4:	00000097          	auipc	ra,0x0
 9b8:	a58080e7          	jalr	-1448(ra) # 40c <exit>
