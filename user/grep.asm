...
000000000000011a <grep>:
{
 ...
 144:	a20b0b13          	addi	s6,s6,-1504 # b60 <buf>
    p = buf;
 148:	8d5a                	mv	s10,s6
        *q = '\n';
 14a:	4aa9                	li	s5,10
...
00000000000001ee <main>:
{
 ...
 262:	87a58593          	addi	a1,a1,-1926 # ad8 <statistics+0x8a>
 266:	4509                	li	a0,2
 ...
 298:	86450513          	addi	a0,a0,-1948 # af8 <statistics+0xaa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 61c:	50050513          	addi	a0,a0,1280 # b18 <digits>
 620:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e8:	434b8b93          	addi	s7,s7,1076 # b18 <digits>
 ...
 828:	2ec90913          	addi	s2,s2,748 # b10 <statistics+0xc2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f0:	26c7b783          	ld	a5,620(a5) # b58 <freep>
 ...
 91e:	00e6ea63          	bltu	a3,a4,932 <free+0x50>
{
 ...
 960:	1ef73e23          	sd	a5,508(a4) # b58 <freep>
}
 964:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 992:	1ca53503          	ld	a0,458(a0) # b58 <freep>
 ...
 9ba:	1a290913          	addi	s2,s2,418 # b58 <freep>
  if(p == (char*)-1)
 9be:	5afd                	li	s5,-1
 9c0:	a88d                	j	a32 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9c2:	00000797          	auipc	a5,0x0
 9c6:	59e78793          	addi	a5,a5,1438 # f60 <base>
 9ca:	00000717          	auipc	a4,0x0
 9ce:	18f73723          	sd	a5,398(a4) # b58 <freep>
 9d2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9f4:	16a73423          	sd	a0,360(a4) # b58 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a68:	0cc50513          	addi	a0,a0,204 # b30 <digits+0x18>
 a6c:	00000097          	auipc	ra,0x0
 a70:	af8080e7          	jalr	-1288(ra) # 564 <open>
  if(fd < 0) {
 a74:	04054263          	bltz	a0,ab8 <statistics+0x6a>
 a78:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a7a:	4481                	li	s1,0
 a7c:	03205063          	blez	s2,a9c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a80:	4099063b          	subw	a2,s2,s1
 a84:	009a05b3          	add	a1,s4,s1
 a88:	854e                	mv	a0,s3
 a8a:	00000097          	auipc	ra,0x0
 a8e:	ab2080e7          	jalr	-1358(ra) # 53c <read>
 a92:	00054563          	bltz	a0,a9c <statistics+0x4e>
      break;
    }
    i += n;
 a96:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a98:	ff24c4e3          	blt	s1,s2,a80 <statistics+0x32>
  }
  close(fd);
 a9c:	854e                	mv	a0,s3
 a9e:	00000097          	auipc	ra,0x0
 aa2:	aae080e7          	jalr	-1362(ra) # 54c <close>
  return i;
}
 aa6:	8526                	mv	a0,s1
 ...
 ab6:	8082                	ret
      fprintf(2, "stats: open failed\n");
 ab8:	00000597          	auipc	a1,0x0
 abc:	08858593          	addi	a1,a1,136 # b40 <digits+0x28>
 ac0:	4509                	li	a0,2
 ac2:	00000097          	auipc	ra,0x0
 ac6:	dbc080e7          	jalr	-580(ra) # 87e <fprintf>
      exit(1);
 aca:	4505                	li	a0,1
 acc:	00000097          	auipc	ra,0x0
 ad0:	a58080e7          	jalr	-1448(ra) # 524 <exit>
