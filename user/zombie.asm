...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	4c450513          	addi	a0,a0,1220 # 858 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a4:	2b090913          	addi	s2,s2,688 # 850 <statistics+0x86>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66c:	2307b783          	ld	a5,560(a5) # 898 <freep>
 ...
 69a:	00e6ea63          	bltu	a3,a4,6ae <free+0x50>
{
 ...
 6dc:	1cf73023          	sd	a5,448(a4) # 898 <freep>
}
 6e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 736:	16690913          	addi	s2,s2,358 # 898 <freep>
  if(p == (char*)-1)
 73a:	5afd                	li	s5,-1
 73c:	a88d                	j	7ae <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 73e:	00000797          	auipc	a5,0x0
 742:	16278793          	addi	a5,a5,354 # 8a0 <base>
 ...
 770:	12a73623          	sd	a0,300(a4) # 898 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 7e4:	09050513          	addi	a0,a0,144 # 870 <digits+0x18>
 7e8:	00000097          	auipc	ra,0x0
 7ec:	af8080e7          	jalr	-1288(ra) # 2e0 <open>
  if(fd < 0) {
 7f0:	04054263          	bltz	a0,834 <statistics+0x6a>
 7f4:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 7f6:	4481                	li	s1,0
 7f8:	03205063          	blez	s2,818 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 7fc:	4099063b          	subw	a2,s2,s1
 800:	009a05b3          	add	a1,s4,s1
 804:	854e                	mv	a0,s3
 806:	00000097          	auipc	ra,0x0
 80a:	ab2080e7          	jalr	-1358(ra) # 2b8 <read>
 80e:	00054563          	bltz	a0,818 <statistics+0x4e>
      break;
    }
    i += n;
 812:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 814:	ff24c4e3          	blt	s1,s2,7fc <statistics+0x32>
  }
  close(fd);
 818:	854e                	mv	a0,s3
 81a:	00000097          	auipc	ra,0x0
 81e:	aae080e7          	jalr	-1362(ra) # 2c8 <close>
  return i;
}
 822:	8526                	mv	a0,s1
 824:	70a2                	ld	ra,40(sp)
 826:	7402                	ld	s0,32(sp)
 828:	64e2                	ld	s1,24(sp)
 82a:	6942                	ld	s2,16(sp)
 82c:	69a2                	ld	s3,8(sp)
 82e:	6a02                	ld	s4,0(sp)
 830:	6145                	addi	sp,sp,48
 832:	8082                	ret
      fprintf(2, "stats: open failed\n");
 834:	00000597          	auipc	a1,0x0
 838:	04c58593          	addi	a1,a1,76 # 880 <digits+0x28>
 83c:	4509                	li	a0,2
 83e:	00000097          	auipc	ra,0x0
 842:	dbc080e7          	jalr	-580(ra) # 5fa <fprintf>
      exit(1);
 846:	4505                	li	a0,1
 848:	00000097          	auipc	ra,0x0
 84c:	a58080e7          	jalr	-1448(ra) # 2a0 <exit>
