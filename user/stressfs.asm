...
main(int argc, char *argv[])
{
  ...
  1a:	95278793          	addi	a5,a5,-1710 # 968 <statistics+0xbc>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	90c50513          	addi	a0,a0,-1780 # 938 <statistics+0x8c>
  ...
  6c:	8e850513          	addi	a0,a0,-1816 # 950 <statistics+0xa4>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8aa50513          	addi	a0,a0,-1878 # 960 <statistics+0xb4>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	43eb8b93          	addi	s7,s7,1086 # 980 <digits>
 ...
 686:	2f690913          	addi	s2,s2,758 # 978 <statistics+0xcc>
        while(*s != 0){
 ...
 77c:	00e6ea63          	bltu	a3,a4,790 <free+0x50>
{
 ...
 7be:	20f73323          	sd	a5,518(a4) # 9c0 <freep>
}
 7c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f0:	1d453503          	ld	a0,468(a0) # 9c0 <freep>
 ...
 818:	1ac90913          	addi	s2,s2,428 # 9c0 <freep>
  if(p == (char*)-1)
 81c:	5afd                	li	s5,-1
 81e:	a88d                	j	890 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 820:	00000797          	auipc	a5,0x0
 824:	1a878793          	addi	a5,a5,424 # 9c8 <base>
 828:	00000717          	auipc	a4,0x0
 82c:	18f73c23          	sd	a5,408(a4) # 9c0 <freep>
 830:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	16a73923          	sd	a0,370(a4) # 9c0 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8c6:	0d650513          	addi	a0,a0,214 # 998 <digits+0x18>
 ...
 91a:	09258593          	addi	a1,a1,146 # 9a8 <digits+0x28>
 91e:	4509                	li	a0,2
