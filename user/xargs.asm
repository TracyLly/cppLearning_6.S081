...
int main(int argc, char *argv[]) {
  ...
  e8:	89c58593          	addi	a1,a1,-1892 # 980 <malloc+0xe6>
  ec:	4509                	li	a0,2
 ...
 16a:	83a58593          	addi	a1,a1,-1990 # 9a0 <malloc+0x106>
 16e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 54c:	48050513          	addi	a0,a0,1152 # 9c8 <digits>
 550:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 618:	3b4b8b93          	addi	s7,s7,948 # 9c8 <digits>
 ...
 758:	26c90913          	addi	s2,s2,620 # 9c0 <malloc+0x126>
        while(*s != 0){
...
free(void *ap)
{
 ...
 820:	1c47b783          	ld	a5,452(a5) # 9e0 <freep>
 ...
 84e:	00e6ea63          	bltu	a3,a4,862 <free+0x50>
{
 ...
 890:	14f73a23          	sd	a5,340(a4) # 9e0 <freep>
}
 894:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8c2:	12253503          	ld	a0,290(a0) # 9e0 <freep>
 ...
 8ea:	0fa90913          	addi	s2,s2,250 # 9e0 <freep>
  if(p == (char*)-1)
 8ee:	5afd                	li	s5,-1
 8f0:	a88d                	j	962 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8f2:	00000797          	auipc	a5,0x0
 8f6:	0f678793          	addi	a5,a5,246 # 9e8 <base>
 8fa:	00000717          	auipc	a4,0x0
 8fe:	0ef73323          	sd	a5,230(a4) # 9e0 <freep>
 902:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 924:	0ca73023          	sd	a0,192(a4) # 9e0 <freep>
      return (void*)(p + 1);
