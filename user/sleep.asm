...
int main(int argc, char *argv[]) {
  ...
  12:	7d258593          	addi	a1,a1,2002 # 7e0 <malloc+0xe8>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	5f4080e7          	jalr	1524(ra) # 60c <fprintf>
    exit(1);
  20:	4505                	li	a0,1
...
free(void *ap)
{
 ...
 67e:	1a67b783          	ld	a5,422(a5) # 820 <freep>
 ...
 6ac:	00e6ea63          	bltu	a3,a4,6c0 <free+0x50>
{
 ...
 6ee:	12f73b23          	sd	a5,310(a4) # 820 <freep>
}
 6f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 720:	10453503          	ld	a0,260(a0) # 820 <freep>
 ...
 748:	0dc90913          	addi	s2,s2,220 # 820 <freep>
  if(p == (char*)-1)
 74c:	5afd                	li	s5,-1
 74e:	a88d                	j	7c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 750:	00000797          	auipc	a5,0x0
 754:	0d878793          	addi	a5,a5,216 # 828 <base>
 758:	00000717          	auipc	a4,0x0
 75c:	0cf73423          	sd	a5,200(a4) # 820 <freep>
 760:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 782:	0aa73123          	sd	a0,162(a4) # 820 <freep>
      return (void*)(p + 1);
