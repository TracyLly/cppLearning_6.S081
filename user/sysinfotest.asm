...
sinfo(struct sysinfo *info) {
  ...
  20:	b4c50513          	addi	a0,a0,-1204 # b68 <statistics+0x88>
...
countfree()
{
  ...
  aa:	ada50513          	addi	a0,a0,-1318 # b80 <statistics+0xa0>
...
testmem() {
 ...
 148:	a7450513          	addi	a0,a0,-1420 # bb8 <statistics+0xd8>
 ...
 162:	a8a50513          	addi	a0,a0,-1398 # be8 <statistics+0x108>
 ...
 17c:	a4050513          	addi	a0,a0,-1472 # bb8 <statistics+0xd8>
 ...
 196:	a5650513          	addi	a0,a0,-1450 # be8 <statistics+0x108>
 ...
 1b2:	a0a50513          	addi	a0,a0,-1526 # bb8 <statistics+0xd8>
...
testcall() {
 ...
 1e4:	b2853503          	ld	a0,-1240(a0) # d08 <__SDATA_BEGIN__>
 ...
 202:	9fa50513          	addi	a0,a0,-1542 # bf8 <statistics+0x118>
 ...
 21c:	9f850513          	addi	a0,a0,-1544 # c10 <statistics+0x130>
...
void testproc() {
 ...
 276:	9ee50513          	addi	a0,a0,-1554 # c60 <statistics+0x180>
 ...
 290:	9b450513          	addi	a0,a0,-1612 # c40 <statistics+0x160>
 ...
 2e0:	98450513          	addi	a0,a0,-1660 # c60 <statistics+0x180>
...
main(int argc, char *argv[])
{
 ...
 302:	99250513          	addi	a0,a0,-1646 # c90 <statistics+0x1b0>
 ...
 32a:	98250513          	addi	a0,a0,-1662 # ca8 <statistics+0x1c8>
...
strcpy(char *s, const char *t)
{
 ...
 34c:	fff5c703          	lbu	a4,-1(a1) # ffffffffffffefff <__global_pointer$+0xffffffffffffdafb>
...
gets(char *buf, int max)
{
 ...
 454:	00098023          	sb	zero,0(s3) # 1000 <__BSS_END__+0x2d8>
  return buf;
}
 458:	855e                	mv	a0,s7
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ae:	61e50513          	addi	a0,a0,1566 # cc8 <digits>
 6b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 77a:	552b8b93          	addi	s7,s7,1362 # cc8 <digits>
 ...
 8ba:	40a90913          	addi	s2,s2,1034 # cc0 <statistics+0x1e0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 982:	3927b783          	ld	a5,914(a5) # d10 <freep>
 ...
 9b0:	00e6ea63          	bltu	a3,a4,9c4 <free+0x50>
{
 ...
 9f2:	32f73123          	sd	a5,802(a4) # d10 <freep>
}
 9f6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a24:	2f053503          	ld	a0,752(a0) # d10 <freep>
 ...
 a4c:	2c890913          	addi	s2,s2,712 # d10 <freep>
  if(p == (char*)-1)
 a50:	5afd                	li	s5,-1
 a52:	a88d                	j	ac4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a54:	00000797          	auipc	a5,0x0
 a58:	2c478793          	addi	a5,a5,708 # d18 <base>
 a5c:	00000717          	auipc	a4,0x0
 a60:	2af73a23          	sd	a5,692(a4) # d10 <freep>
 a64:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a86:	28a73723          	sd	a0,654(a4) # d10 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 afa:	1ea50513          	addi	a0,a0,490 # ce0 <digits+0x18>
 afe:	00000097          	auipc	ra,0x0
 b02:	af8080e7          	jalr	-1288(ra) # 5f6 <open>
  if(fd < 0) {
 b06:	04054263          	bltz	a0,b4a <statistics+0x6a>
 b0a:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 b0c:	4481                	li	s1,0
 b0e:	03205063          	blez	s2,b2e <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 b12:	4099063b          	subw	a2,s2,s1
 b16:	009a05b3          	add	a1,s4,s1
 b1a:	854e                	mv	a0,s3
 b1c:	00000097          	auipc	ra,0x0
 b20:	ab2080e7          	jalr	-1358(ra) # 5ce <read>
 b24:	00054563          	bltz	a0,b2e <statistics+0x4e>
      break;
    }
    i += n;
 b28:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 b2a:	ff24c4e3          	blt	s1,s2,b12 <statistics+0x32>
  }
  close(fd);
 b2e:	854e                	mv	a0,s3
 b30:	00000097          	auipc	ra,0x0
 b34:	aae080e7          	jalr	-1362(ra) # 5de <close>
  return i;
}
 b38:	8526                	mv	a0,s1
 ...
 b4e:	1a658593          	addi	a1,a1,422 # cf0 <digits+0x28>
 b52:	4509                	li	a0,2
 b54:	00000097          	auipc	ra,0x0
 b58:	dbc080e7          	jalr	-580(ra) # 910 <fprintf>
      exit(1);
 b5c:	4505                	li	a0,1
 b5e:	00000097          	auipc	ra,0x0
 b62:	a58080e7          	jalr	-1448(ra) # 5b6 <exit>
