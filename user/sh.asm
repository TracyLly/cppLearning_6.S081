...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	32a58593          	addi	a1,a1,810 # 1388 <statistics+0x94>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2f850513          	addi	a0,a0,760 # 1390 <statistics+0x9c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3cc70713          	addi	a4,a4,972 # 1490 <statistics+0x19c>
    ...
    panic("runcmd");
      ...
      e2:	2ba50513          	addi	a0,a0,698 # 1398 <statistics+0xa4>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	2a058593          	addi	a1,a1,672 # 13a0 <statistics+0xac>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	26458593          	addi	a1,a1,612 # 13b0 <statistics+0xbc>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1de50513          	addi	a0,a0,478 # 13c0 <statistics+0xcc>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e46b8b93          	addi	s7,s7,-442 # 13e8 <statistics+0xf4>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e1450513          	addi	a0,a0,-492 # 13c8 <statistics+0xd4>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d5460613          	addi	a2,a2,-684 # 13f0 <statistics+0xfc>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d44b0b13          	addi	s6,s6,-700 # 1410 <statistics+0x11c>
  ...
  return ret;
     ...
     70a:	cf250513          	addi	a0,a0,-782 # 13f8 <statistics+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c9850513          	addi	a0,a0,-872 # 1400 <statistics+0x10c>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c7660613          	addi	a2,a2,-906 # 1418 <statistics+0x124>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	c0ea0a13          	addi	s4,s4,-1010 # 1420 <statistics+0x12c>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	be060613          	addi	a2,a2,-1056 # 1428 <statistics+0x134>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b4260613          	addi	a2,a2,-1214 # 13f0 <statistics+0xfc>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b6260613          	addi	a2,a2,-1182 # 1440 <statistics+0x14c>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b1050513          	addi	a0,a0,-1264 # 1430 <statistics+0x13c>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b1850513          	addi	a0,a0,-1256 # 1448 <statistics+0x154>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b4c70713          	addi	a4,a4,-1204 # 14a8 <statistics+0x1b4>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a5860613          	addi	a2,a2,-1448 # 1460 <statistics+0x16c>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a2a58593          	addi	a1,a1,-1494 # 1468 <statistics+0x174>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6dc080e7          	jalr	1756(ra) # 1124 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	9a850513          	addi	a0,a0,-1624 # 13f8 <statistics+0x104>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	a0648493          	addi	s1,s1,-1530 # 1478 <statistics+0x184>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a8848493          	addi	s1,s1,-1400 # 1520 <buf.1141>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a7ba0a13          	addi	s4,s4,-1413 # 1523 <buf.1141+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9d0a8a93          	addi	s5,s5,-1584 # 1480 <statistics+0x18c>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	9ee50513          	addi	a0,a0,-1554 # 1520 <buf.1141>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec2:	60a50513          	addi	a0,a0,1546 # 14c8 <digits>
     ec6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f8e:	53eb8b93          	addi	s7,s7,1342 # 14c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ce:	3f690913          	addi	s2,s2,1014 # 14c0 <statistics+0x1cc>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1196:	3867b783          	ld	a5,902(a5) # 1518 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x50>
{
  ...
  freep = p;
    ...
    1206:	30f73b23          	sd	a5,790(a4) # 1518 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1238:	2e453503          	ld	a0,740(a0) # 1518 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1260:	2bc90913          	addi	s2,s2,700 # 1518 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    1266:	a88d                	j	12d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1268:	00000797          	auipc	a5,0x0
    126c:	32078793          	addi	a5,a5,800 # 1588 <base>
    1270:	00000717          	auipc	a4,0x0
    1274:	2af73423          	sd	a5,680(a4) # 1518 <freep>
    ...
    129a:	28a73123          	sd	a0,642(a4) # 1518 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
  ...
  fd = open("statistics", O_RDONLY);
    ...
    130e:	1d650513          	addi	a0,a0,470 # 14e0 <digits+0x18>
    1312:	00000097          	auipc	ra,0x0
    1316:	af8080e7          	jalr	-1288(ra) # e0a <open>
  if(fd < 0) {
  ...
  for (i = 0; i < sz; ) {
    ...
    1334:	ab2080e7          	jalr	-1358(ra) # de2 <read>
  ...
  close(fd);
    ...
    1348:	aae080e7          	jalr	-1362(ra) # df2 <close>
  return i;
}
    134c:	8526                	mv	a0,s1
    ...
    1362:	19258593          	addi	a1,a1,402 # 14f0 <digits+0x28>
    1366:	4509                	li	a0,2
    1368:	00000097          	auipc	ra,0x0
    136c:	dbc080e7          	jalr	-580(ra) # 1124 <fprintf>
      exit(1);
    1370:	4505                	li	a0,1
    1372:	00000097          	auipc	ra,0x0
    1376:	a58080e7          	jalr	-1448(ra) # dca <exit>
