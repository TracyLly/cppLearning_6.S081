...
fmtname(char *path)
{
  ...
  6a:	b5a98993          	addi	s3,s3,-1190 # bc0 <buf.1115>
...
ls(char *path)
{
 ...
 128:	a0c50513          	addi	a0,a0,-1524 # b30 <statistics+0xbc>
 ...
 166:	99e58593          	addi	a1,a1,-1634 # b00 <statistics+0x8c>
 16a:	4509                	li	a0,2
 ...
 17c:	9a058593          	addi	a1,a1,-1632 # b18 <statistics+0xa4>
 180:	4509                	li	a0,2
 ...
 1ae:	99650513          	addi	a0,a0,-1642 # b40 <statistics+0xcc>
 ...
 1f4:	968a0a13          	addi	s4,s4,-1688 # b58 <statistics+0xe4>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	920a8a93          	addi	s5,s5,-1760 # b18 <statistics+0xa4>
...
main(int argc, char *argv[])
{
 ...
 2be:	8ae50513          	addi	a0,a0,-1874 # b68 <statistics+0xf4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 642:	53a50513          	addi	a0,a0,1338 # b78 <digits>
 646:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 70e:	46eb8b93          	addi	s7,s7,1134 # b78 <digits>
 ...
 84e:	32690913          	addi	s2,s2,806 # b70 <statistics+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 916:	2a67b783          	ld	a5,678(a5) # bb8 <freep>
 ...
 944:	00e6ea63          	bltu	a3,a4,958 <free+0x50>
{
 ...
 986:	22f73b23          	sd	a5,566(a4) # bb8 <freep>
}
 98a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b8:	20453503          	ld	a0,516(a0) # bb8 <freep>
 ...
 9e0:	1dc90913          	addi	s2,s2,476 # bb8 <freep>
  if(p == (char*)-1)
 9e4:	5afd                	li	s5,-1
 9e6:	a88d                	j	a58 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9e8:	00000797          	auipc	a5,0x0
 9ec:	1e878793          	addi	a5,a5,488 # bd0 <base>
 9f0:	00000717          	auipc	a4,0x0
 9f4:	1cf73423          	sd	a5,456(a4) # bb8 <freep>
 9f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a1a:	1aa73123          	sd	a0,418(a4) # bb8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a8e:	10650513          	addi	a0,a0,262 # b90 <digits+0x18>
 a92:	00000097          	auipc	ra,0x0
 a96:	af8080e7          	jalr	-1288(ra) # 58a <open>
  if(fd < 0) {
 ...
 ab4:	ab2080e7          	jalr	-1358(ra) # 562 <read>
 ...
 ac8:	aae080e7          	jalr	-1362(ra) # 572 <close>
  return i;
}
 acc:	8526                	mv	a0,s1
 ...
 ae2:	0c258593          	addi	a1,a1,194 # ba0 <digits+0x28>
 ae6:	4509                	li	a0,2
 ae8:	00000097          	auipc	ra,0x0
 aec:	dbc080e7          	jalr	-580(ra) # 8a4 <fprintf>
      exit(1);
 af0:	4505                	li	a0,1
 af2:	00000097          	auipc	ra,0x0
 af6:	a58080e7          	jalr	-1448(ra) # 54a <exit>
