...
cat(int fd)
{
  ...
  44:	90858593          	addi	a1,a1,-1784 # 948 <statistics+0x8a>
  48:	4509                	li	a0,2
  ...
  72:	8f258593          	addi	a1,a1,-1806 # 960 <statistics+0xa2>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	87658593          	addi	a1,a1,-1930 # 978 <statistics+0xba>
 10a:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 698:	2fc90913          	addi	s2,s2,764 # 990 <statistics+0xd2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 760:	27c7b783          	ld	a5,636(a5) # 9d8 <freep>
 ...
 78e:	00e6ea63          	bltu	a3,a4,7a2 <free+0x50>
{
 ...
 7d0:	20f73623          	sd	a5,524(a4) # 9d8 <freep>
}
 7d4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 802:	1da53503          	ld	a0,474(a0) # 9d8 <freep>
 ...
 82a:	1b290913          	addi	s2,s2,434 # 9d8 <freep>
  if(p == (char*)-1)
 82e:	5afd                	li	s5,-1
 830:	a88d                	j	8a2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 832:	00000797          	auipc	a5,0x0
 836:	3ae78793          	addi	a5,a5,942 # be0 <base>
 83a:	00000717          	auipc	a4,0x0
 83e:	18f73f23          	sd	a5,414(a4) # 9d8 <freep>
 842:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 864:	16a73c23          	sd	a0,376(a4) # 9d8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8d8:	0dc50513          	addi	a0,a0,220 # 9b0 <digits+0x18>
 8dc:	00000097          	auipc	ra,0x0
 8e0:	af8080e7          	jalr	-1288(ra) # 3d4 <open>
  if(fd < 0) {
 8e4:	04054263          	bltz	a0,928 <statistics+0x6a>
 8e8:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8ea:	4481                	li	s1,0
 8ec:	03205063          	blez	s2,90c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8f0:	4099063b          	subw	a2,s2,s1
 8f4:	009a05b3          	add	a1,s4,s1
 8f8:	854e                	mv	a0,s3
 8fa:	00000097          	auipc	ra,0x0
 8fe:	ab2080e7          	jalr	-1358(ra) # 3ac <read>
 902:	00054563          	bltz	a0,90c <statistics+0x4e>
      break;
    }
    i += n;
 906:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 908:	ff24c4e3          	blt	s1,s2,8f0 <statistics+0x32>
  }
  close(fd);
 90c:	854e                	mv	a0,s3
 90e:	00000097          	auipc	ra,0x0
 912:	aae080e7          	jalr	-1362(ra) # 3bc <close>
  return i;
}
 916:	8526                	mv	a0,s1
 ...
 92c:	09858593          	addi	a1,a1,152 # 9c0 <digits+0x28>
 930:	4509                	li	a0,2
 932:	00000097          	auipc	ra,0x0
 936:	dbc080e7          	jalr	-580(ra) # 6ee <fprintf>
      exit(1);
 93a:	4505                	li	a0,1
 93c:	00000097          	auipc	ra,0x0
 940:	a58080e7          	jalr	-1448(ra) # 394 <exit>
